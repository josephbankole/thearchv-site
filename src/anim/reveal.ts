 ...
 *
 * 3. The reveal is a fade and nothing else. The first version also translated the card down 16px
 *    at rest, which pushed it past the rail's bottom padding edge and turned every day rail into a
 *    vertical scroll container that swallowed page swipes on a phone. That shipped and had to be
 *    rolled back the same day (trap 3 in CLAUDE.md). Do not add a transform to [data-inview].
 */
